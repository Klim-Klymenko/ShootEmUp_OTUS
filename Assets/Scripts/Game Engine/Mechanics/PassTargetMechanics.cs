...
{
    public sealed class PassTargetMechanics
    {
        ...
        public PassTargetMechanics(IAtomicFunction<Collision, bool> passCondition, IAtomicAction<AtomicObject> onCollisionAction)
        {
